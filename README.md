...
- [ ] `transformer_block`   Implement the Transformer block (3 pts)
- [ ] `transformer_lm`   Implementing the Transformer LM (3 pts)
...
- [ ] `gradient_clipping`   Implement gradient clipping (1 pt)
